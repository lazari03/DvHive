...
<template>
  <div class="w-fill flex justify-evenly m-6 flex-col md:flex-row gap-4 md:gap-0">
    <template v-for="step in stepsData" :key="step.step_nr">
      <Steps
        :step_nr="step.step_nr"
        :step_tittle="step.step_tittle"
